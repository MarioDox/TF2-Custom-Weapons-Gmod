...
if (CLIENT) then
	...
	SWEP.PrintName			= "The Samson Skewer"	
	SWEP.Slot				= 2
	SWEP.SlotPos			= 1
...
SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/player/items/heavy/pn2_knife_lunchbox.mdl", bone = "vm_weapon_bone", rel = "", pos = Vector(-11.912, -9.667, 41.77), angle = Angle(180, 20.826, 3.802), size = Vector(0.944, 0.944, 0.944), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/player/items/heavy/pn2_knife_lunchbox.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(41.09, 14.859, -10.688), angle = Angle(180, -117.85, 92.635), size = Vector(0.944, 0.944, 0.944), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
