function SWEP:Melee(ent)
	...
	if ( trace.Hit ) then
			...
			self.Weapon:EmitSound("physics/cardboard/cardboard_box_impact_soft1.wav")
			else
			self.Weapon:EmitSound("physics/cardboard/cardboard_box_impact_soft1.wav")
			end
...
if (CLIENT) then
	...
	SWEP.PrintName			= "Broom'ash'er"	
	SWEP.Slot				= 2
	SWEP.SlotPos			= 1
	SWEP.DrawSecondaryAmmo = false
	SWEP.DrawAmmo		= false
	SWEP.Type =  "Broom"
	SWEP.Stats =  "+50% attack speed rate"
	SWEP.Stats2 = "+50% Attack range"
	SWEP.Stats3 = ""
	SWEP.Stats4 = ""
	SWEP.Stats5 = ""
	SWEP.Stats6 = ""
	...
	SWEP.Stats8 = ""
	SWEP.Stats9 = ""
	SWEP.Stats10 = "-75% Attack penality"
	SWEP.Stats11 = ""
	SWEP.Stats12 = ""
	SWEP.Stats13 = ""
	SWEP.Stats14 = ""
...
self:Holster2()
	...
	if self.Weapon:GetNWBool("Critical") then
	vm:SendViewModelMatchingSequence(vm:LookupSequence("fa_swing_c"))
