...
if (CLIENT) then
	...
	SWEP.PrintName			= "Heavy force"	
	SWEP.Slot				= 2
	SWEP.SlotPos			= 1
	SWEP.DrawSecondaryAmmo = false
	SWEP.DrawAmmo		= false
	SWEP.Type =  "Barbell"
	SWEP.Stats =  "+75% damage done"
	SWEP.Stats2 = "+20% attack range"
	SWEP.Stats3 = ""
	SWEP.Stats4 = ""
	SWEP.Stats5 = ""
	SWEP.Stats6 = ""
	...
	SWEP.Stats8 = ""
	SWEP.Stats9 = ""
	SWEP.Stats10 = "This weapon deploys 100% slower"
	SWEP.Stats11 = "+5% attack delay"
	SWEP.Stats12 = ""
	SWEP.Stats13 = ""
	SWEP.Stats14 = ""
	SWEP.Stats15 = ""
	SWEP.Stats16 = ""
	SWEP.Description = "Heavy has a lot of force!"
end

SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/props_2fort/trainwheel004.mdl", bone = "weapon_bone", rel = "", pos = Vector(0.588, 0.677, -8.863), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/props_2fort/trainwheel004.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.4, -7.522, -1.306), angle = Angle(0, 0, 90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
self:Holster2()
	...
	self.DoMelee = CurTime() + 0.5
	self.Weapon:SetNextPrimaryFire(CurTime() + self.Primary.Delay)
	self.Weapon:SetNextSecondaryFire(CurTime() + self.Primary.Delay)
	self.Idle = CurTime() + 2.4
