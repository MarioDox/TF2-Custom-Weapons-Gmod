...
if (CLIENT) then
	...
	SWEP.PrintName			= "Burning torch"	
	SWEP.Slot				= 2
	SWEP.SlotPos			= 1
	SWEP.DrawSecondaryAmmo = false
	SWEP.DrawAmmo		= false
	SWEP.Type =  "Torch"
	SWEP.Stats =  "On Hit: Burn target"
	SWEP.Stats2 = "+50% faster attack rate"
	SWEP.Stats3 = ""
	SWEP.Stats4 = ""
	SWEP.Stats5 = ""
	SWEP.Stats6 = ""
	...
	SWEP.Stats15 = ""
	SWEP.Stats16 = ""
	SWEP.Description = "Other than doing light it can set people on fire."
end

SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/props_medieval/brazier.mdl", bone = "weapon_bone", rel = "", pos = Vector(-1.124, 13.456, 1.121), angle = Angle(0, 0, -90), size = Vector(0.523, 0.523, 0.635), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
self.Idle = nil
local vm = self.Owner:GetViewModel()
vm:SendViewModelMatchingSequence(vm:LookupSequence("melee_allclass_idle"))
end
