function SWEP:Melee()
	...
	if ( trace.Hit ) then
			...
			self.Weapon:EmitSound("Weapon_bat.HitFlesh")
			else
			self.Weapon:EmitSound("Weapon_bat.HitWorld")
			end
...
if (CLIENT) then
	...
	SWEP.Stats2 = "+20 health given when equipped"
	...
	SWEP.Stats15 = ""
	SWEP.Stats16 = ""
	SWEP.Description = "Bonk them all!"
end
...
SWEP.Model = "models/weapons/c_models/c_bonk_bat/c_bonk_bat.mdl"
