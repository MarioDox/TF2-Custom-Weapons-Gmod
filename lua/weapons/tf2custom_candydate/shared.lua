...
if (CLIENT) then
	...
	SWEP.PrintName			= "Candy'd'ate"	
	SWEP.Slot				= 2
	SWEP.SlotPos			= 1
	SWEP.DrawSecondaryAmmo = false
	SWEP.DrawAmmo		= false
	SWEP.Type =  "Candy cane"
	SWEP.Stats =  ""
	SWEP.Stats2 = "+25% damage done"
	SWEP.Stats3 = ""
	SWEP.Stats4 = ""
	SWEP.Stats5 = ""
	SWEP.Stats6 = ""
	...
	SWEP.Stats15 = ""
	SWEP.Stats16 = ""
	SWEP.Description = "Medic gives candy to bad guys, then fix their teeth."
end


SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/weapons/c_models/c_crusaders_crossbow/c_crusaders_crossbow_xmas_proj.mdl", bone = "weapon_bone", rel = "", pos = Vector(-0.222, 2.95, 21.784), angle = Angle(69.686, -97.208, 174.729), size = Vector(4.204, 4.204, 4.204), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/weapons/c_models/c_crusaders_crossbow/c_crusaders_crossbow_xmas_proj.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.489, 0.978, -1.622), angle = Angle(0, 0, 0), size = Vector(2.581, 2.581, 2.581), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
