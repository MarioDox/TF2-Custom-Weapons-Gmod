...
if (CLIENT) then
	...
	SWEP.PrintName			= "Captain's stick"	
	SWEP.Slot				= 2
	SWEP.SlotPos			= 1
	SWEP.DrawSecondaryAmmo = false
	SWEP.DrawAmmo		= false
	SWEP.Type =  "Stick"
	SWEP.Stats =  "+20% attack speed rate"
	SWEP.Stats2 = ""
	SWEP.Stats3 = ""
	SWEP.Stats4 = ""
	SWEP.Stats5 = ""
...
SWEP.ViewModelBoneMods = {
	["bip_upperArm_L"] = { scale = Vector(1, 1, 1), pos = Vector(-30, -30, -30), angle = Angle(0, 0, 0) }
}
SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/player/items/demo/pegleg.mdl", bone = "bip_lowerArm_R", rel = "", pos = Vector(2, -28.566, -10.933), angle = Angle(-10.834, -9.292, 83.391), size = Vector(1.125, 1.125, 1.125), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/player/items/demo/pegleg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(11.916, 3.766, -13.761), angle = Angle(0, -96.897, 62.88), size = Vector(0.955, 0.955, 0.955), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	...
	function SWEP:ViewModelDrawn()
		...
		for k, name in ipairs( self.vRenderOrder ) do
			...
			if (v.type == "Model" and IsValid(model)) then
				...
				model:DrawModel()
				model:ManipulateBoneScale( model:LookupBone("bip_knee_r"), Vector(0,0,0) )
				model:ManipulateBoneScale( model:LookupBone("bip_foot_r"), Vector(0,0,0) )
				model:ManipulateBoneScale( model:LookupBone("bip_toe_r"), Vector(0,0,0) )
				render.SetBlend(1)
